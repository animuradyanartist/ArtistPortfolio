...
- July 23, 2025: Added dual feedback collection system with both React-based widget (blue button, bottom-right) and HTML/JavaScript-based quick feedback script (green button, bottom-left). Both widgets collect star ratings (1-5) and detailed messages, storing data to PostgreSQL database via `/api/feedback` endpoint. Enhanced user feedback collection options for better visitor engagement and experience analysis.
